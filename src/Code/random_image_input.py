...
if __name__ == '__main__':
    ...
    parser.add_argument('--ref_dir', help='input reference dir', default='Input/Images')
    ...
    parser.add_argument('--mode', help='task to be done', default='random_samples')
    ...
    #    print("output already exist")
        ...
        if (opt.gen_start_scale < 1) | (opt.gen_start_scale > (len(Gs)-1)):
            ...
            plt.imsave('%s/start_scale=%d.png' % (dir2save,opt.gen_start_scale), functions.convert_image_np(out.detach()), vmin=0, vmax=1)
